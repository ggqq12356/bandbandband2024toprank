        ...
        <div class="d-flex flex-row justify-content-start align-items-center ms-2">
          <div class="d-flex flex-column justify-content-center align-items-start">
            <p>
              ...
              <span class="ms-2" style="color: grey;">${score}</span>
            </p>
            <p>
...
const eventBind = () => {
  document.querySelector("#topBand").addEventListener("click", () => { getTopRank("band") })
  document.querySelector("#topVocalist").addEventListener("click", () => { getTopRank("vocal") })
  document.querySelector("#topGuitarist").addEventListener("click", () => { getTopRank("guitar") })
  document.querySelector("#topBassist").addEventListener("click", () => { getTopRank("bass") })
  document.querySelector("#topDrummer").addEventListener("click", () => { getTopRank("drum") })
  document.querySelector("#topKeyboard").addEventListener("click", () => { getTopRank("keyboard") })
  document.querySelector("#topPlayer").addEventListener("click", () => { getTopRank("player") })
}
